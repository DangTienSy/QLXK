...
{
    public partial class FormLOAIVE : Form
    {
        ...
        private void FormLOAIVE_Load(object sender, EventArgs e)
        {
            LoadDataGridView();
            huy();
        }
        ...
        {
            dgv.DataSource = DataAccess.GetDataTable("select * from LOAIVE order by MALOAIVE");
        }
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            string cmd = String.Format("insert into LOAIVE(tenLOAIVE) values ({0})", t);
            ...
            foreach (DataGridViewCell cell in dgv.SelectedCells)
                if (cell.Selected)
                {
                    try
                    {
                        ...
                        string cmd = String.Format("delete from LOAIVE WHERE MALOAIVE={0}", ma);
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.SelectedCells[0].Selected)
            {
                try
                {
                    ...
                    string cmd = String.Format("update LOAIVE set TENLOAIVE={0} WHERE MALOAIVE={1}", t, ma);
                    if (DataAccess.Execute(cmd))
                    {
                        LoadDataGridView();
                        huy();
